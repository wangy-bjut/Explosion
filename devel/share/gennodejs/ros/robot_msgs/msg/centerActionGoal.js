...
class centerActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = centerGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new centerActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = centerGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new centerGoal()
    }
...
module.exports = centerActionGoal;
