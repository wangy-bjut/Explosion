...
class centerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new centerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = centerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new centerActionFeedback(null);
    ...
    data.feedback = centerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += centerFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new centerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = centerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new centerFeedback()
    }
...
module.exports = centerActionFeedback;
