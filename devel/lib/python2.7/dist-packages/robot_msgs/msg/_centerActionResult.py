...
"""autogenerated by genpy from robot_msgs/centerActionResult.msg. Do not edit."""
import codecs
import sys
...
class centerActionResult(genpy.Message):
  _md5sum = "d6bb15f97ff839d3aaad6cdeb6d81aa0"
  _type = "robot_msgs/centerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_msgs/centerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(centerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_msgs.msg.centerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_msgs.msg.centerResult()
