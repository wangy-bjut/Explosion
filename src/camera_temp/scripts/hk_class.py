...
class NET_DVR_JPEGPICTURE_WITH_APPENDDATA(Structure):
    _fields_ = [('dwSize', c_int32), ('dwChannel', c_int32), ('dwJpegPicLen', c_int32),
                ('pJpegPicBuff', POINTER(BYTE_ARRAY)), ('dwJpegPicWidth', c_int32),
                ('dwJpegPicHeight', c_int32), ('dwP2PDataLen', c_int32),
...
class NET_DVR_REALTIME_THERMOMETRY_COND(Structure):
    _fields_=[('dwSize', c_uint32),('dwChan', c_uint32),('byRuleCalibType', c_ubyte),
              ('byMode', c_ubyte),('wInterval', c_short),('byRes', c_char * NAME_LEN)]
