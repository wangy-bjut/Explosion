...
public:
    ...
    RobotOdom():nh("~")
    {
        ros::Subscriber odom_sub = nh.subscribe<nav_msgs::Odometry>("odom", 10, &RobotOdom::odomCallback,this);
            
        ros::Publisher dgps_pub = nh.advertise<robot_msgs::dgps>("ZGPS", 100);
